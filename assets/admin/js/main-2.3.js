...
//approve selected feedbacks
function approveSelectedfeedbacks() { 
    var commentIds = [];
    $("input[name='checkbox-table']:checked").each(function () {
        commentIds.push(this.value);
    });
    ...
    $.ajax({
        type: 'POST',
        url: MdsConfig.baseURL + '/AdminController/approveSelectedfeedbacks',
        data: setAjaxData(data),
        success: function (response) {
            location.reload();
        }
...
function approveSelectedContactUsForms() { 
    var commentIds = [];
    $("input[name='checkbox-table']:checked").each(function () {
        commentIds.push(this.value);
    });
    ...
    $.ajax({
        type: 'POST',
        url: MdsConfig.baseURL + '/AdminController/approveSelectedContactUsForms',
        data: setAjaxData(data),
        success: function (response) {
            location.reload();
        }
...
function approveSelectedSponsorshipForms() { 
    var commentIds = [];
    $("input[name='checkbox-table']:checked").each(function () {
        commentIds.push(this.value);
    });
    ...
    $.ajax({
        type: 'POST',
        url: MdsConfig.baseURL + '/AdminController/approveSelectedSponsorshipForms',
        data: setAjaxData(data),
        success: function (response) {
            location.reload();
        }
...
//approve selected volunteer forms
function approveSelectedvolunteerforms() {  
    var commentIds = [];
    $("input[name='checkbox-table']:checked").each(function () {
        commentIds.push(this.value);
    });
    ...
    $.ajax({
        type: 'POST',
        url: MdsConfig.baseURL + '/AdminController/approveSelectedvolunteerforms',
        data: setAjaxData(data),
        success: function (response) {
            location.reload();
        }
...
function deleteSelectedfeedbacks(message) { 
    swal(swalOptions(message)).then(function (isConfirm) {
        if (isConfirm) {
            var commentIds = [];
            $("input[name='checkbox-table']:checked").each(function () {
            ...
            $.ajax({
                type: 'POST',
                url: MdsConfig.baseURL + '/AdminController/deleteSelectedfeedbacks',
                data: setAjaxData(data),
                success: function (response) {
                    location.reload();
                }
...
function deleteSelectedContactUsForms(message) { 
    swal(swalOptions(message)).then(function (isConfirm) {
        if (isConfirm) {
            var commentIds = [];
            $("input[name='checkbox-table']:checked").each(function () {
            ...
            $.ajax({
                type: 'POST',
                url: MdsConfig.baseURL + '/AdminController/deleteSelectedContactUsForms',
                data: setAjaxData(data),
                success: function (response) {
                    location.reload();
                }
...
function deleteSelectedSponsorshipForms(message) { 
    swal(swalOptions(message)).then(function (isConfirm) {
        if (isConfirm) {
            var commentIds = [];
            $("input[name='checkbox-table']:checked").each(function () {
            ...
            $.ajax({
                type: 'POST',
                url: MdsConfig.baseURL + '/AdminController/deleteSelectedSponsorshipForms',
                data: setAjaxData(data),
                success: function (response) {
                    location.reload();
                }
...
//delete selected Volunteer Forms
function deleteSelectedVolunteerForms(message) { 
    swal(swalOptions(message)).then(function (isConfirm) {
        if (isConfirm) {
            var commentIds = [];
            $("input[name='checkbox-table']:checked").each(function () {
            ...
            $.ajax({
                type: 'POST',
                url: MdsConfig.baseURL + '/AdminController/deleteSelectedVolunteerForms',
                data: setAjaxData(data),
                success: function (response) {
                    location.reload();
                }
