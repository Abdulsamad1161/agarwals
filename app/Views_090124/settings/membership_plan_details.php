    ...
    <div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-sm-12">
				<div class="title">
					<h1 class="picture_gallery_h1"><?= trans("current_plan"); ?></h1>
				</div>
			</div>
			<div class="col-md-2"></div>
		</div>
                    ...
                    <div class="profile-tab-content">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control form-input" value="<?= formatDateShort($plan_details->plan_start_date); ?>" readonly>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="form-group">
									<label class="control-label"><?= trans('membership').' '.trans('end_date'); ?></label>
									<input type="text" class="form-control form-input" value="<?= formatDateShort($plan_details->plan_end_date); ?>" readonly>
								</div>
							</div>
						</div>
						...
						{?>
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center align-items-center">
									<div class="box">
										<a class="btn btn-sm btn-danger btn-radius"href="<?= base_url().'/abcmembership' ?>"><span><?php echo trans('buy_now'); ?></span>
										</a>
									</div>
								</div>
							</div>
