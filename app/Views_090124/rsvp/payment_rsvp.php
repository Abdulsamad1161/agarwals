                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-8">
                            <div class="left">
                                ...
                                <?php endif; ?>
                                <div class="tab-checkout tab-checkout-closed">
                                    <?php if ($mdsPaymentType == 'rsvpPayment' || $mdsPaymentType == 'promote'): ?>
                                        <a href="<?= generateUrl('profilePayment', 'payment_method_users'); ?>?payment_type=<?= $mdsPaymentType; ?>"><h2 class="title">
                                        ...
                                        <a href="<?= generateUrl('profilePayment', 'payment_method_users'); ?>?payment_type=<?= $mdsPaymentType; ?>" class="link-underlined"><?= trans("edit"); ?></a>
                                    <?php else: ?>
                                        <a href="<?= generateUrl('profilePayment', 'payment_method_users'); ?>"><h2 class=" title">
                                                <?php if (!empty($cartHasPhysicalProduct) && $productSettings->marketplace_shipping == 1 && $mdsPaymentType == 'sale') {
                                                    echo '2.';
                                                } else {
                                                    echo '1.';
                                                ...
                                                &nbsp;<?= trans("payment_method"); ?></h2></a>
                                        <a href="<?= generateUrl('profilePayment', 'payment_method_users'); ?>" class="link-underlined"><?= trans("edit"); ?></a>
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            if (!empty($cartPaymentMethod->payment_option)) {
                                                ...
                                                //load view
                                                if (empty($cartPaymentMethod->payment_option)) {
                                                    redirectToBackUrl(generateUrl('profilePayment', 'payment_method_users'));
                                                }
                                                echo view('rsvp/payment_methods/_' . $cartPaymentMethod->payment_option, $data);
                                             ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php if ($mdsPaymentType == 'rsvpPayment'):
                            echo view('rsvp/_order_summary_rsvp');
                        endif; ?>
                    </div>
                </div>
            </div>
