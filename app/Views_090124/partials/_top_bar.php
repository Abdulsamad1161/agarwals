...
<ul class="navbar-nav">
	<li class="nav-item">
		...
		<i class = "fa fa-user" style="color:white !important;font-size: 16px;">&nbsp;&nbsp;</i><span style="color : white !important;"><?php echo $nameValue . ' : ' . 'ABC-' . user()->id; ?></span>
		</a>
	</li>
</ul>
<?php }
...
<li><a href="<?= generateUrl('settings', 'edit_profile'); ?>"><i class="icon-settings"></i><?= trans("profile_management"); ?></a></li>
<li><a href="<?= adminUrl('ticket-booking'); ?>"><i class="fa fa-ticket"></i><?= trans("ticket_booking"); ?></a></li>
<li><a href="<?= adminUrl('members'); ?>"><i class="fa fa-users"></i><?= trans("members"); ?></a></li>
<li><a href="<?= generateUrl("feedback"); ?>"><i class="fa fa-comment"></i><?= trans("feedback"); ?></a></li>
<li><a href="<?= generateUrl("rsvpEventForm"); ?>"><i class="fa fa-file"></i><?= trans("rsvpEventForm"); ?></a></li>
...
{
?>
<a href="javascript:void(0)" style="color : white !important;" data-toggle="modal" data-target="#registerModal" class="nav-link">Guest Login</a>
<?php 
}	?>
</li>
<?php endif; ?>
