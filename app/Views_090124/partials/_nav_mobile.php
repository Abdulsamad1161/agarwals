...
if (authCheck()): ?>
<a href="<?= generateDashUrl("add_product"); ?>" class="btn btn-md btn-danger btn-radius"><?= trans("sell_now"); ?></a>
<?php else: ?>
<a href="javascript:void(0)" class="btn btn-md btn-danger btn-radius close-menu-click" data-toggle="modal" data-target="#loginModal"><?= trans("sell_now"); ?></a>
<?php endif;
endif; ?>
</div>
</div>
...
{
?>
<li class="nav-item"><a href="javascript:void(0)" data-toggle="modal" data-target="#registerModal" class="nav-link close-menu-click">Guest Login</a></li>
<?php 
}	?>
<?php endif;
