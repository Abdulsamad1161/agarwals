<div class="box">
    <div class="box-header with-border">
        ...
        <div class="right">
			<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalSendEmail">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="table-responsive">
                        ...
                        <div class="col-sm-12">
                            <form action="<?= adminUrl('users'); ?>" method="get">
                                ...
                                <div class="item-table-filter item-table-filter-long">
                                    ...
                                    <input name="isMember" type="checkbox" value="1" <?= (esc(inputGet('isMember')) == 1) ? 'checked' : ''; ?>> Members
                                </div>
					...
					<span>Total Count of Records : <?php if (!empty($users)): echo count($users); endif;?></span>
                    <table class="table table-bordered table-striped">
                        ...
                        if (!empty($users)):
                            foreach ($users as $user):
                                ...
                                $membershipPlanUsers = $membershipModel->getUserPlanByUserIdUsers($user->id, false);
                                ...
                                <tr>
                                    ...
                                    <td><?= !empty($membershipPlanUsers) ? esc($membershipPlanUsers->plan_title).' '.esc($membershipPlanUsers->number_of_days) : ''; ?></td>
                                    <td>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" name ="confirmed" id="checkbox1" value="1">
									<label class="form-check-label" for="checkbox1">Check to get the Confirmed Members List</label>
								</div>
                            </div>
							...
							<div class="form-group">
                                <div class="form-check form-check-inline">
									...
									<label class="form-check-label" for="checkbox2">Check to get the Unconfirmed Members List</label>
								</div>
                            </div>
                        </div>
                        <div class="modal-footer">
