...
<div class="header_spons">
	<div class="overlay">
		<h1 class="header_spons_h1">Upcoming Events & Calendar</h1>
	</div>
</div>
            ...
            <div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12 col-sm-12" style="text-align : right;">
						<p class="animated-text">Discover Your Next Adventure: Explore Our Event Calendar!</p>
					</div>
				</div>
								...
								<tr class="inner-box">
									<th scope="row">
										<div class="event-date">
											...
											<p><?= date_format($eventDate, 'M'); ?> - <?= date_format($eventDate, 'Y'); ?></p>
										</div>
									</th>
									<td>
										<div class="event-img">
											<?php if(!empty($event->oragnizerImage))
											{ ?>
												<img src="<?= base_url().'/'.$event->oragnizerImage; ?>" alt="Organizer Image" />
											<?php } 
											else
											{ ?>
												<img src="<?= getLogo(); ?>" alt="Organizer Image" />
											<?php } ?>
									...
									<td>
										<div class="r-no">
											<?= htmlspecialchars($event->event_shortLocation); ?>
										</div>
									</td>
									<td>
										<div class="primary-btn">	
											<a class="btn btn-sm btn-danger" style="font-size: 14px;padding: 11px;border-radius: 50px;" href="<?= adminUrl('show-event-details/' . $event->id); ?>">Read More</a>
										</div>
									</td>
								</tr>
							<?php endforeach; ?>
