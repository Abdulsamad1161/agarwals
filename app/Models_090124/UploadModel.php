...
class UploadModel extends BaseModel
{
    ...
    {
        return $this->upload($inputName, 'uploads/event-Invitation/', 'eventImage_', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	//custom added
	public function uploadOragnizerImage($inputName)
    {
        return $this->upload($inputName, 'uploads/event-Invitation/', 'oragnizerImage_', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	//custom added
	public function uploadEventImageTicket($inputName)
    {
        return $this->upload($inputName, 'uploads/event-Invitation/ticket_event_image/', 'eventImageTicket_', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	public function uploadCharityImage($inputName)
    {
        return $this->upload($inputName, 'uploads/charity/', 'charityImage_', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	public function uploadseatlayoutImage($inputName)
    {
        return $this->upload($inputName, 'uploads/event-Invitation/ticket_event_image/', 'eventseatingLayout_', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	public function uploadProfileImageDirectors($inputName)
    {
        return $this->upload($inputName, 'uploads/boardOfDirectors/', 'boardImage_', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	public function uploadOurSponsorsImage($inputName)
    {
        return $this->upload($inputName, 'uploads/ourSponsors/', 'sponsors_', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	public function uploadCoversImage($inputName)
    {
        return $this->upload($inputName, 'uploads/coverImage/', 'coverImage_', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	public function uploadVideoThumbImage($inputName)
    {
        return $this->upload($inputName, 'uploads/video/thumbnail_image/', 'thumb', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	public function uploadgalleryThumbImage($inputName)
    {
        return $this->upload($inputName, 'uploads/images/thumbnail_image/', 'front', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
	
	public function uploadMembershipImage($inputName)
    {
        return $this->upload($inputName, 'uploads/membership/', 'top_image', ['jpg', 'jpeg', 'png', 'gif', 'svg']);
    }
}
