<?php if (!empty($paymentGateway) && $paymentGateway->name_key == 'stripe'):
    ...
    'amount' => $totalAmount, // Amount in the smallest currency unit (e.g., 100 for ₹1.00)
    'currency' => 'INR',      // Indian Rupees
    'payment_method_types' => ['card'],  // Payment type
    'description' => 'Export of goods - Order #1234',  // Required description for export transactions
    'shipping' => [
        'name' => 'John Doe',  // Customer's full name
        'address' => [
            'line1' => '1234 MG Road',  // Address line
            'city' => 'Bangalore',      // City name
            'postal_code' => '560001',  // Postal code
            ...
            stripe.confirmCardPayment(clientSecret, {
                ...
                if (result.error) {
                    ...
                    if (result.paymentIntent.status === 'succeeded') {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: MdsConfig.baseURL + '/stripe-payment-post-ticket',
