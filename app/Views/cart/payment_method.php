...
<script>
	...
	radio.addEventListener("click", function() {
		swal({
		  ...
		  text: "You can complete your e-payment by using the provided email address (abcpayment20@gmail.com). Your business membership will be confirmed on receipt of e-transfer payment. Thank you!",
		  buttons: [
			'back',
			'ok'
		  ],
		  dangerMode: true,
			...
			if (isConfirm) 
			{
				...
				$.ajax({
					type: 'POST',
					url: MdsConfig.baseURL + '/MembershipPlansUsersController/epaymentMethodBookingBuisness',	
					data: setAjaxData(data),
					 ...
					 success: function (response) {
						...
						{
							window.location.href = "<?= langBaseUrl(); ?>"
						}
