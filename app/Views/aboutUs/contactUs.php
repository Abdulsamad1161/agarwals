					...
					<form action="<?= base_url('SponsorshipController/sendContactUSPost'); ?>" method="post" id="contactUsForm">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<img src="" name="captcha_image" id="captchaImage" data-value="1" style="height: 50px; width: 150px; border: 1px solid #eeee; background: gray;" class="img-fluid">
								&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="font-weight-bold mt-3" style="font-size: 16px">=</span>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="text" class="form-control" style="height: 50px;" required id="captcha_text" name="captcha_text">
							</div>
						</div>
...
<script>
    ...
    function updateCaptchaImage() {
        $('#captchaImage').attr('src', captchaImages[currentImageIndex].src).data('value', captchaImages[currentImageIndex].value);
    }
	...
	*/
    $('#contactUsForm').submit(function(event) {
			...
			// var captchaImage = $('#captchaImage').data('value');
