<div class="header_spons">
	<div class="overlay">
		<h1 class="header_spons_h1">RSVP Form</h1>
	</div>
</div>
									...
									<div class='item-container'>
										...
										<input type="hidden" name ="label<?php echo $form->forms[$i]->formNameAttribute; ?>" value="<?php echo $form->forms[$i]->formLabel; ?>">
										 ...
										 <div class="quantity">
											...
											<input name="quantity<?php echo $form->forms[$i]->formNameAttribute; ?>" type="text" class="myqty qtyfield totalQty<?php echo $form->form_id; ?><?php echo $form->forms[$i]->formNameAttribute; ?>" value="0" readonly>
		...
		<?php }?>
            ...
            <div class="row">
                <div class="col-12 text-right mt-4">
					<?php /*If payment is not compulsory, please check this checkbox &nbsp;&nbsp;<input type = "checkbox" value="1" name ="payNow">&nbsp;&nbsp;*/ ?>
					(If you’re a member, please check the box and then hit the submit button)&ensp;<input type = "checkbox" value="1" name ="payNow">
...
$(document).ready(function() {
    // Clear input fields
    $('.qtyfield').val(0);
    $('#totalAmount<?php echo $form->form_id; ?>').val(0.00);
});
$(document).ready(function() {
    ...
    ?>
    // Initialize subtotals array for each field
    subtotals[<?php echo $i; ?>] = 0;
    ...
    $('.minus<?php echo $form->form_id; ?><?php echo $form->forms[$i]->formNameAttribute; ?>').on('click', function(e) {
        ...
        // Calculate and update the subtotal for this field
        var quantity = value;
        var price = parseFloat($('.number-field<?php echo $form->form_id; ?><?php echo $form->forms[$i]->formNameAttribute; ?>').val());
        subtotals[<?php echo $i; ?>] = quantity * price;

        // Update the totalAmount by summing all subtotals
        totalAmount = subtotals.reduce((acc, curr) => acc + curr, 0);
