            ...
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <div class="m-t-45 text-center">
                        <a href="<?= base_url('invoice-membership-users/'. $transaction->id); ?>" class="btn btn-lg btn-info color-white" target="_blank"><i class="icon-text-o"></i>&nbsp;&nbsp;<?= trans("view_invoice"); ?></a>
                        <?php if(!empty(helperGetSession('modesy_membership_request_type')) && helperGetSession('modesy_membership_request_type') == 'renew'): ?>
...
<?php 
helperDeleteSession('modesy_selected_membership_plan_id');
helperDeleteSession('plan_purchase_details');
