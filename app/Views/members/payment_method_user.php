                        ...
                        <div class="col-sm-12 col-lg-8">
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-open">
                                    ...
                                    <form action="<?= base_url('MembershipPlansUsersController/paymentMethodPostUsers'); ?>" method="post" id="form_validate" class="validate_terms">
                                        <?= csrf_field(); ?>
...
<script>
	...
	radio.addEventListener("click", function() {
		swal({
		  ...
		  text: "You can complete your e-payment by using the provided email address (abcpayment20@gmail.com). Your membership will be confirmed on receipt of e-transfer payment. Thank you!",
		  buttons: [
			'back',
			'ok'
		  ],
		  dangerMode: true,
			...
			if (isConfirm) 
			{
				...
				$.ajax({
					type: 'POST',
					url: MdsConfig.baseURL + '/MembershipPlansUsersController/epaymentMethodBooking',	
					data: setAjaxData(data),
					 ...
					 success: function (response) {
						...
						else if(parsedData.result === 2)
						{
							swal({
							  title: "Information",
							  text: "There is no such Plan, kindly check with organization",
							  buttons: [
								'cancel',
								'ok'
							  ],
						...
						else
						{
							swal({
							  title: "Error occured",
							  text: "Contact Admin to check your membership status",
							  buttons: [
								'cancel',
								'ok'
							  ],
