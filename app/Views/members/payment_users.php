                ...
                <div class="shopping-cart shopping-cart-shipping">
                    <div class="row">
                            ...
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-closed">
                                    <?php if ($mdsPaymentType == 'membership' || $mdsPaymentType == 'promote'): ?>
                                        <a href="<?= generateUrl('membershipPlansUsers', 'payment_method_users'); ?>?payment_type=<?= $mdsPaymentType; ?>"><h2 class="title">
                                        ...
                                        <a href="<?= generateUrl('membershipPlansUsers', 'payment_method_users'); ?>?payment_type=<?= $mdsPaymentType; ?>" class="link-underlined"><?= trans("edit"); ?></a>
                                    <?php else: ?>
                                        <a href="<?= generateUrl('membershipPlansUsers', 'payment_method_users'); ?>"><h2 class=" title">
                                                <?php if (!empty($cartHasPhysicalProduct) && $productSettings->marketplace_shipping == 1 && $mdsPaymentType == 'sale') {
                                                    echo '2.';
                                                } else {
                                                    echo '1.';
                                                ...
                                                &nbsp;<?= trans("payment_method"); ?></h2></a>
                                        <a href="<?= generateUrl('membershipPlansUsers', 'payment_method_users'); ?>" class="link-underlined"><?= trans("edit"); ?></a>
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            if (!empty($cartPaymentMethod->payment_option)) {
                                                ...
                                                //load view
                                                if (empty($cartPaymentMethod->payment_option)) {
                                                    redirectToBackUrl(generateUrl('membershipPlansUsers', 'payment_method_users'));
                                                }
                                                echo view('members/payment_methods/_' . $cartPaymentMethod->payment_option, $data);
                                             ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php if ($mdsPaymentType == 'membership'):
                            echo view('members/_order_summary_membership_users');
                        endif; ?>
                    </div>
                </div>
            </div>
