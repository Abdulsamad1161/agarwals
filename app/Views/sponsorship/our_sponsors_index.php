    ...
    <div class="row padding_row">
		...
		?>
			<div class="col-md-6 col-sm-12">
				...
				?>
				<div class="card profile-card-5 top-height1">
    		        <div class="card-img-block">
    		            <img class="card-img-top" src="<?= $img_url;?>" alt="sponsor image" style="width:50%;max-width: 100%;height: auto;object-fit: contain;">
    		        </div>
                    <div class="card-body pt-0 mt-4 top-height1">
