            ...
            <div class="container-invoice">
                <div id="content" class="card">
                    <div class="card-body invoice p-0">
                        <div class="row">
                            <div class="col-12">
                                <h1 style="text-align: center; font-size: 36px;font-weight: 400;margin-top: 20px;"><?= trans("membership"); ?>&nbsp;<?= trans("invoice"); ?></h1>
                            </div>
                        </div>
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= trans("invoice"); ?>:</span>#ABC-MP<?= $transaction->id; ?></p>
                                    <p class="font-weight-bold"><span style="display: inline-block;width: 100px;"><?= trans("date"); ?>:</span><?= formatDate($transaction->created_at); ?></p>
									<p class="font-weight-bold"><span style="display: inline-block;width: 100px;"><?= trans("member_id"); ?>:</span>ABC-<?= $transaction->user_id; ?></p>
									<p class="font-weight-bold"><span style="display: inline-block;width: 100px;"><?= trans("expiry_date"); ?>:</span><?= formatDateShort($transaction->plan_expiry_date); ?></p>
                                </div>
                            </div>
                        </div>
