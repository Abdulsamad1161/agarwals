                ...
                <div class="box-body">
					...
					<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-12 col-option">
                                <input type="radio" name="guest_login" value="1" id="guest_login_1" class="square-purple" <?= $generalSettings->guest_login == 1 ? 'checked' : ''; ?>>
                                <label for="guest_login_1" class="option-label"><?= trans('enable'); ?></label>
                            </div>
                            <div class="col-sm-6 col-xs-12 col-option">
                                <input type="radio" name="guest_login" value="0" id="guest_login_2" class="square-purple" <?= $generalSettings->guest_login != 1 ? 'checked' : ''; ?>>
                                <label for="guest_login_2" class="option-label"><?= trans('disable'); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
