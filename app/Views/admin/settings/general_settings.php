                ...
                <div class="tab-content settings-tab-content">
                    ...
                    <div class="tab-pane<?= $activeTab == '3' ? ' active' : ''; ?>" id="tab_3">
						...
						<div class="form-group">
                            <div class="row">
                                <div class="col-sm-3 col-xs-12 col-lang">
                                    <label>Show Facebook Page</label>
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="showFacebookPage" value="1" id="showFacebookPage_1" class="square-purple" <?= $settings->showFacebookPage == 1 ? 'checked' : ''; ?>>
                                    <label for="showFacebookPage_1" class="option-label"><?= trans('yes'); ?></label>
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="showFacebookPage" value="0" id="showFacebookPage_2" class="square-purple" <?= $settings->showFacebookPage != 1 ? 'checked' : ''; ?>>
                                    <label for="showFacebookPage_2" class="option-label"><?= trans('no'); ?></label>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group" style="display:none;">
                            <div class="row">
                                <div class="col-sm-3 col-xs-12 col-lang">
                                    <label>Show Twitter Page</label>
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="showTwitterPage" value="1" id="showTwitterPage_1" class="square-purple" <?= $settings->showTwitterPage == 1 ? 'checked' : ''; ?>>
                                    <label for="showTwitterPage_1" class="option-label"><?= trans('yes'); ?></label>
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="showTwitterPage" value="0" id="showTwitterPage_2" class="square-purple" <?= $settings->showTwitterPage != 1 ? 'checked' : ''; ?>>
                                    <label for="showTwitterPage_2" class="option-label"><?= trans('no'); ?></label>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group" style="display:none;">
                            <div class="row">
                                <div class="col-sm-3 col-xs-12 col-lang">
                                    <label>Show Instagram Page</label>
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="showInstagramPage" value="1" id="showInstagramPage_1" class="square-purple" <?= $settings->showInstagramPage == 1 ? 'checked' : ''; ?>>
                                    <label for="showInstagramPage_1" class="option-label"><?= trans('yes'); ?></label>
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="showInstagramPage" value="0" id="showInstagramPage_2" class="square-purple" <?= $settings->showInstagramPage != 1 ? 'checked' : ''; ?>>
                                    <label for="showInstagramPage_2" class="option-label"><?= trans('no'); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
