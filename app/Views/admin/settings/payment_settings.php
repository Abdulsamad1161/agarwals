...
<div class="row">
	...
	<div class="col-lg-6 col-md-12">
        <?php $epayment = getPaymentGateway('epayment');
        if (!empty($epayment)):?>
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title"><?= $epayment->name; ?></h3>
			</div>
			<form action="<?= base_url('AdminController/ePaymentGatewaySettingsPost'); ?>" method="post">
				<?= csrf_field(); ?>
				<input type="hidden" name="name_key" value="epayment">
				<div class="box-body">
					<div class="form-group">
						<div class="row">
							<div class="col-md-4 col-sm-12">
							...
							<div class="col-md-4 col-sm-12 col-option">
								<div class="custom-control custom-radio">
									<input type="radio" name="status" value="1" id="status_stripe_3" class="custom-control-input" <?= $epayment->status == 1 ? 'checked' : ''; ?>>
									<label for="status_stripe_3" class="custom-control-label"><?= trans("enable"); ?></label>
								</div>
							</div>
							<div class="col-md-4 col-sm-12 col-option">
								<div class="custom-control custom-radio">
									<input type="radio" name="status" value="0" id="status_stripe_4" class="custom-control-input" <?= $epayment->status != 1 ? 'checked' : ''; ?>>
									<label for="status_stripe_4" class="custom-control-label"><?= trans("disable"); ?></label>
								</div>
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label">E-payment Mail</label>
						<input type="text" class="form-control" name="logos" placeholder="" value="<?= esc($epayment->logos); ?>">
					</div>
