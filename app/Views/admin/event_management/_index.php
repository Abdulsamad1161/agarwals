                ...
                <div class="box-body">
					<div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'>
								Upload Image
								<input type="file" name="eventImage" size="40" accept=".png, .jpg, .jpeg, .heic" onchange="$('#upload-file-info35').html($(this).val());">
							</a>
							(.png, .jpg, .jpeg, .heic)
						</div>
					...
					<div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'>
								Upload Image
								<input type="file" name="gallery_image" size="40" accept=".png, .jpg, .jpeg, .heic" onchange="$('#upload-file-info36').html($(this).val());">
							</a>
							(.png, .jpg, .jpeg, .heic)
						</div>
					...
					<div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'>
								Upload Image
								<input type="file" name="library_image" size="40" accept=".png, .jpg, .jpeg, .heic" onchange="$('#upload-file-info37').html($(this).val());">
							</a>
							(.png, .jpg, .jpeg, .heic)
						</div>
					...
					<div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'>
								Upload Image
								<input type="file" name="charity_image" size="40" accept=".png, .jpg, .jpeg, .heic" onchange="$('#upload-file-info38').html($(this).val());">
							</a>
							(.png, .jpg, .jpeg, .heic)
						</div>
                    ...
                    <div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'>
								...
								<input type="file" name="fileuploads[]" size="40" accept=".png, .jpg, .jpeg, .gif, .svg, .heic" onchange="$('#upload-file-info1').html($(this).val());" multiple required>
							</a>
							(.png, .jpg, .jpeg, .gif, .svg, .heic)
						</div>
					...
					<div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'>
								...
								<input type="file" name="eventImage" size="40" accept=".png, .jpg, .jpeg, .gif, .svg, .heic" onchange="$('#upload-file-info7').html($(this).val());">
							</a>
							(.png, .jpg, .jpeg, .gif, .svg, .heic)
						</div>
					...
					<div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'>
								...
								<input type="file" name="oragnizerImage" size="40" accept=".png, .jpg, .jpeg, .gif, .svg, .heic" onchange="$('#upload-file-info8').html($(this).val());">
							</a>
							(.png, .jpg, .jpeg, .gif, .svg, .heic)
						</div>
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'> 
								Upload Front Image
								<input type="file" name="frontImage" size="40" accept=".png, .jpg, .jpeg, .heic" onchange="$('#upload-file-info13').html($(this).val());">
							</a>
							(.png, .jpg, .jpeg, .heic)
						</div>
...
<div class="row">
        ...
        <div class="box">
            ...
            <form action="<?= base_url('AdminController/galleryVideoPost'); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="box-body">
					...
					<div class="form-group">
                        <label>Order</label> <p style="color:red;font-weight:bold;">Note : The order will be in descending order on the Video Gallery page.</p>
					...
					<!-- <div class="form-group">
						...
						<div class="display-block">
							<a class='btn btn-success btn-sm btn-file-upload'>
								...
								<input type="file" name="thumbImage" size="40" accept=".png, .jpg, .jpeg, .heic" onchange="$('#upload-file-info10').html($(this).val());">
							</a>
							(.png, .jpg, .jpeg, .heic)
						</div>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Add Registration Form</h3>
            </div>
            <form action="<?= base_url('AdminController/registrationFormPost'); ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
				
				<div class="box-body">
					<div class="form-group">
                        <label>JOT Form URL</label>
                        <input type="text" class="form-control" name="jot_form_url" placeholder="Ex : https://form.jotform.com/250467618" required>
                    </div>
					...
					<div class="form-group">
                        ...
                        <select class="form-control" name="event_id" required>
                            ...
                            <?php foreach($eventsList as $events){ ?>
                                <option value="<?= $events->id; ?>"><?= $events->event_name. ' (' .$events->event_date. ')'; ?></option>
                            <?php } ?>
                        </select>
                    </div>
				...
				<div class="box-footer">
                    <button type="submit" class="btn btn-primary pull-right">Add Form</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6">
        <div class="box">
            <div class="box-header with-border">
                <div class="text-center">
                    <h3 class="box-title">Registration Form Link</h3>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped cs_datatable_lang" role="grid" aria-describedby="example1_info">
                                ...
                                <tbody>
                                <?php if (!empty($registrationFormList)):
									$i = 1;
                                    foreach ($registrationFormList as $item): ?>
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td><?= esc($item->jot_form_url); ?></td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <button class="btn bg-purple dropdown-toggle btn-select-option" type="button" data-toggle="dropdown"><?= trans('select_option'); ?><span class="caret"></span></button>
                                                    <ul class="dropdown-menu options-dropdown">
                                                        <li><a href="<?= adminUrl('edit-registration-form/' . $item->id); ?>"><i class="fa fa-edit option-icon"></i><?= trans('edit'); ?></a></li>
														
                                                        <li><a href="javascript:void(0)" onclick="deleteItem('AdminController/deleteRegistrattionFormDataPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
