        ...
        <div class="box box-primary">
            ...
            <form action="<?= base_url('AdminController/editvideoGalleryPost'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
					...
					<div class="form-group">
                        <label>Order</label> <p style="color:red;font-weight:bold;">Note : The order will be in descending order on the Gallery page.</p>
                        <input type="number" class="form-control" name="order" placeholder="Ex : 1" min="1" value="<?= $galleryVideos->order;?>"  required>
                    </div>
