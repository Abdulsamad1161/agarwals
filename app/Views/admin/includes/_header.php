    ...
    <aside class="main-sidebar" style="background-color: #343B4A;">
        <section class="sidebar sidebar-scrollbar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
				...
				<li class="nav-digital-sales">
                    <a href="<?= adminUrl('ticket-manager'); ?>"><i class="fa fa-ticket"></i><span><?= trans("ticket_manager"); ?></span></a>
				</li>
				
				<li class="treeview<?php isAdminNavActive(['charity-manager', 'charity-transactions']); ?>">
					<a href="#"><i class="fa fa-plus-circle" aria-hidden="true"></i><span><?= trans("charity_manager"); ?></span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
					<ul class="treeview-menu">
						<li class="nav-charity-manager"><a href="<?= adminUrl('charity-manager'); ?>"> <?= trans("charity_manager"); ?></a></li>
						<li class="nav-charity-transactions"><a href="<?= adminUrl('charity-transactions'); ?>"> <?= trans("transactions"); ?></a></li>
					</ul>
                </li>
                <?php
                ...
                if (hasPermission('pages') || hasPermission('blog') || hasPermission('location')):?>
					...
					<li class="treeview<?php isAdminNavActive(['rsvp-form', 'rsvp-form-report', 'rsvp-form-transactions']); ?>">
                            <a href="#"><i class="fa fa-file-powerpoint-o"></i><span><?= trans("rsvpEventForm"); ?></span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
                                <li class="nav-rsvp-form"><a href="<?= adminUrl('rsvp-form'); ?>"> <?= trans("rsvpEventFormCreate"); ?></a></li>
                                <li class="nav-rsvp-form-report"><a href="<?= adminUrl('rsvp-form-report'); ?>"> <?= trans("rsvpEventFormreport"); ?></a></li>
								<li class="nav-rsvp-form-transactions"><a href="<?= adminUrl('rsvp-form-transactions'); ?>"> <?= trans("transactions"); ?></a></li>
                            </ul>
                     </li>
					 
					<li class="nav-board-of-directors">
                        <a href="<?= adminUrl('board-of-directors'); ?>"><i class="fa fa-users"></i><span><?= trans("board-of-directors"); ?></span></a>
                    </li>

					<li class="nav-board-of-directors-sub">
                        <a href="<?= adminUrl('board-of-directors-sub'); ?>"><i class="fa fa-users"></i><span>Past Presidents</span></a>
                    </li>
					
					<li class="nav-board-of-directors-library">
                        <a href="<?= adminUrl('library'); ?>"><i class="fa fa-university"></i><span><?= trans("library-management"); ?></span></a>
                    </li>
					
					<li class="nav-our-sponsors">
                        <a href="<?= adminUrl('our-sponsors'); ?>"><i class="fa fa-handshake-o"></i><span><?= trans("sponsors-management"); ?></span></a>
                    </li>
					
					<li class="nav-sponsorship-report">
                        <a href="<?= adminUrl('sponsorship-report'); ?>"><i class="fa fa-commenting"></i><span><?= trans("sponsorship-report"); ?></span></a>
                    </li>
					
					<li class="nav-contactUs-report">
                        <a href="<?= adminUrl('contactUs-report'); ?>"><i class="fa fa-comments"></i><span><?= trans("contactUs-report"); ?></span></a>
                    </li>
					
					<li class="nav-pages-content">
						<a href="<?= adminUrl('pages-content'); ?>"><i class="fa fa-file"></i><span>Dynamic Content</span></a>
					</li>
					
					<li class="nav-pages-content">
						<a href="<?= adminUrl('external-organization'); ?>"><i class="fa fa-file"></i><span>External Organization</span></a>
					</li>
                    ...
                    <?php endif; ?>
						<li class="nav-pages-content">
						<a href="<?= adminUrl('documents'); ?>"><i class="fa fa-file-pdf-o"></i><span>Documents</span></a>
					</li>
					<?php 
                endif;
                if (hasPermission('membership')):?>
					...
					<li class="nav-user-migration">
                        <a href="<?= adminUrl('users-migration'); ?>"><i class="fa fa-user"></i><span>Member Migration</span></a>
                    </li>
					
					<li class="treeview<?php isAdminNavActive(['membership-plan-user', 'transactions-membership-users', 'transactions-membership-users-epayment']); ?>">
                        <a href="#"><i class="fa fa-user"></i><span><?= trans("membership_plans_users"); ?></span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                        <ul class="treeview-menu">
                            <li class="nav-membership-plans"><a href="<?= adminUrl('membership-plan-user'); ?>"> <?= trans("membership_plans_users"); ?></a></li>
                            <li class="nav-transactions-membership-users"><a href="<?= adminUrl('transactions-membership-users'); ?>"> <?= trans("transactions"); ?></a></li>
							<li class="nav-transactions-membership-users-epayment"><a href="<?= adminUrl('transactions-membership-users-epayment'); ?>"> E-payment Transactions</a></li>
                        </ul>
                    </li>

                    <li class="treeview<?php isAdminNavActive(['membership-plans', 'transactions-membership' ,'transactions-membership-epayment']); ?>">
                        <a href="#"><i class="fa fa-truck"></i><span><?= trans("membership_plans_vendors"); ?></span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                        <ul class="treeview-menu">
                            <li class="nav-membership-plans"><a href="<?= adminUrl('membership-plans'); ?>"> <?= trans("membership_plans_vendors"); ?></a></li>
                            <li class="nav-transactions-membership"><a href="<?= adminUrl('transactions-membership'); ?>"> <?= trans("transactions"); ?></a></li>
							<li class="nav-transactions-membership-epayment"><a href="<?= adminUrl('transactions-membership-epayment'); ?>">  E-payment Transactions</a></li>
                        </ul>
                    </li>
                ...
                <?php endif; ?>
					<li class="nav-reviews">
                        <a href="<?= adminUrl('volunteer-forms'); ?>"><i class="fa fa-handshake-o"></i><span><?= trans("volunteer_forms"); ?></span></a>
                    </li>
				<?php 
                ...
                <?php endif;
                    $showMtTools = true; ?>
                    <li class="treeview<?php isAdminNavActive(['feedback-report','feedback-pending','feedback-report-event','feedback-report-event']); ?>">
                        <a href="#"><i class="fa fa-comment"></i><span><?= trans("feedback"); ?></span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                        <ul class="treeview-menu">
							<?php if ($generalSettings->comment_approval_system == 1): ?>
                                <li class="nav-feedback-report"><a href="<?= adminUrl('feedback-report'); ?>"> <?= trans("general_feedbacks"); ?></a></li>
                                <li class="nav-feedback-report-event"><a href="<?= adminUrl('feedback-report-event'); ?>"> <?= trans("event_feedbacks"); ?></a></li>
							<?php else: ?>
								<li class="nav-feedback-pending"><a href="<?= adminUrl('feedback-pending'); ?>"> <?= trans("general_feedbacks"); ?></a></li>
                                <li class="nav-feedback-pending-event"><a href="<?= adminUrl('feedback-pending-event'); ?>"> <?= trans("event_feedbacks"); ?></a></li>
							<?php endif; ?>
                        </ul>
                    </li>
                <?php
                    ...
                    if (hasPermission('general_settings')):?>
                        <li class="treeview<?php isAdminNavActive(['general-settings', 'language-settings', 'social-login', 'update-language', 'edit-translations', 'email-settings', 'visual-settings', 'font-settings']); ?>">
                            ...
                            <ul class="treeview-menu">
								...
								<li class="nav-general-settings"><a href="<?= adminUrl('event-settings'); ?>"> <?= trans("event_settings"); ?></a></li>
