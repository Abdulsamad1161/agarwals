    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="left">
                    <h3 class="box-title">Edit Past President</h3>
                </div>
                <div class="right">
            ...
            <form action="<?= base_url('AdminController/editBoardDirectorsSubPost'); ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="box-body">
							...
							<div class="col-md-6 col-lg-6 col-sm-12" style="text-align : center;">
								...
								<div class="image-card">
									...
									<div class="card-buttons" style="margin-top:7px;">
										<a class="btn btn-sm btn-danger" onclick="deleteItem('AdminController/deleteBoardDirectorImageSubPost','<?= $boardMembers->id; ?>','<?= trans("confirm_delete_images", true); ?>');"><?= trans("delete"); ?></a>
									</div>
								</div>
							</div>
