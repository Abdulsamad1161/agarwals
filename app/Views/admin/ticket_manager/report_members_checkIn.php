        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="text-center">
                    <h3 class="box-title font-design">Attendees <?= trans('report').' - '.$tickets->event_name.' ('.$tickets->event_date.')'; ?></h3>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped cs_datatable_lang" id="exampleData" role="grid" aria-describedby="example5_info">
                                <thead>
                                <tr role="row">
