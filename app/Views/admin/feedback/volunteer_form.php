<div class="row" style="margin-bottom: 15px;">
    <div class="col-sm-12">
        <h3 style="font-size: 18px; font-weight: 600;"><?= trans('volunteer_forms'); ?></h3>
    </div>
</div>
<div class="box">
        ...
        <div class="row">
            <div class="col-sm-12">
                        ...
                        if (!empty($volunteer)):
                            foreach ($volunteer as $item):?>
                                <tr>
                                    ...
                                    <td class="break-word"><?= esc($item->area_of_interest); ?></td>
                                    <td><?= formatDate($item->submit_date); ?></td>
                                    <td>
                                        <form action="<?= base_url('AdminController/approveVolunteerFormPost'); ?>" method="post">
                                            <?= csrf_field(); ?>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    ...
                                                    <?php endif; ?>
                                                    <li><a href="javascript:void(0)" onclick="deleteItem('AdminController/deleteVolunteerForm','<?= $item->id; ?>','<?= trans("confirm_volunteer", true); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a></li>
                                                </ul>
                                            </div>
                                        </form>
                                    </td>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="pull-left">
                            <button class="btn btn-sm btn-danger btn-table-delete" onclick="deleteSelectedVolunteerForms('<?= trans("confirm_volunteers", true); ?>');"><?= trans('delete'); ?></button>
                            <?php if ($showApproveButton == true): ?>
                                <button class="btn btn-sm btn-success btn-table-delete" onclick="approveSelectedvolunteerforms();"><?= trans('approve'); ?></button>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
