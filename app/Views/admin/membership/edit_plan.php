                    ...
                    <div class="form-inline m-b-15">
                        ...
                        <div>
                            <div class="form-group form-group-duration" <?= $plan->is_unlimited_time == 1 ? 'style="display:none;"' : ''; ?>>
                                <input type="text" name="number_of_days" value="<?= !empty($plan->number_of_days) ? $plan->number_of_days : ''; ?>" class="form-control form-input m-r-10" placeholder="<?= trans("duration") ?>&nbsp;&nbsp;(E.g: 1 Year)" <?= empty($plan->is_unlimited_time) ? 'required' : ''; ?> style="min-width: 400px; max-width: 100%;" onblur="validateDuration(this.value)">
                            </div>
                            <div class="form-group">
                                <div class="col-custom-option">
                                    <div class="custom-control custom-checkbox">
