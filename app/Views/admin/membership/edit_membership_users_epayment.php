    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
				...
				<div class="right">
                    <a href="<?= adminUrl('transactions-membership-users-epayment'); ?>" class="btn btn-danger btn-add-new">
                        <i class="fa fa-angle-double-left"></i>&nbsp;&nbsp;<?= trans('back'); ?>
                    </a>
                </div>
            </div>
			<form action="<?= base_url('MembershipController/editApproveEpayment'); ?>" method="post">
                <?= csrf_field(); ?>
			<div class="box-body">
				<div class="row">
