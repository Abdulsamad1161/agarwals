    ...
    <div class="col-lg-12 col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <div class="pull-left">
                    <h3 class="box-title"><?= trans('e-payment-report'); ?> - Membership</h3>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        <li class="green-hover" style="background: #00c300 !important;"><a class="green-hover" style="color: white !important;" href="<?= adminUrl('edit-epayment-details-membership-users/' . $item->random_ref_no); ?>"><i class="fa fa-check-circle option-icon"></i><?= trans('approve'); ?></a></li>
														
														<li class="red-hover" style="background: red !important;margin-top: 5px !important;"><a class="red-hover" href="javascript:void(0)" style="color: white !important;" onclick="deleteItem('MembershipController/rejectEpaymentApprovalMembershipUsers','<?= $item->random_ref_no; ?>','<?= trans("confirm_reject", true); ?>');"><i class="fa fa-times-circle option-icon"></i><?= trans('reject'); ?></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
...
[
		...
		'email_priority' => 1,
		'email_subject' => 'Membership Paymemt Confirmation E-payment',
