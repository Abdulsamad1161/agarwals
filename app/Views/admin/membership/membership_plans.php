<div class="row">
        ...
        <div class="box box-primary">
            ...
            <form action="<?= base_url('MembershipController/addPlanPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-inline option-plan-type m-b-15" style="display : none;">
                            ...
                            <div class="form-group">
                                <div class="col-custom-option">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="is_unlimited_number_of_ads" id="checkbox_is_unlimited_number_of_ads" value="1" class="custom-control-input" checked>
                    ...
                    <div class="form-inline m-b-15">
                        ...
                        <div>
                            <div class="form-group form-group-duration">
                                <input type="text" class="form-control form-input m-r-10" name="number_of_days"  placeholder="<?= trans("duration") ?>&nbsp;&nbsp;(E.g: 1 Year)" required style="min-width: 400px; max-width: 100%;" onblur="validateDuration(this.value)">
                            </div>
                            <div class="form-group">
                                <div class="col-custom-option">
                                    <div class="custom-control custom-checkbox">
						...
						<small>Kindly add only two partitions of text in this field, Example - 30 Days, 1 Year, 90 Days it should be like this. **There should be a gap between the text and the number as shown in example.</small>
                    </div>
                    <div class="form-inline m-b-15">
    ...
    <?php /* <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <?php foreach ($membershipPlans as $plan): ?>
                    <div class="price-box">
                        ...
                        <div class="price-box-inner">
							...
							<div class="plan-price text-center">
                                <h3><strong class="font-600" style="font-size: 40px;color: #2e2eff;">
                                        <?php 
...
function validateDuration(value) {
    // Regular expression to match the pattern of "number space unit"
    var pattern = /^\d+\s+\w+$/;

    if (!pattern.test(value)) {
        alert("Please enter a valid duration, e.g., '30 days'.");
        // You can also reset the input value or take other actions as needed
    }
}
