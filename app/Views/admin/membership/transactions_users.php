            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    <div class="row table-filter-container">
                        <div class="col-sm-12">
                            <form action="<?= adminUrl('transactions-membership-users'); ?>" method="get">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($item->payment_status == "awaiting_payment"): ?>
                                            <form action="<?= base_url('MembershipController/approvePaymentPostUsers'); ?>" method="post">
                                                <?= csrf_field(); ?>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-option">
                                            <a href="<?= base_url('invoice-membership-users/' . $item->id); ?>" class="btn btn-sm btn-default btn-edit" target="_blank"><i class="fa fa-file-text"></i>&nbsp;&nbsp;<?= trans("view_invoice"); ?></a>
                                            <a href="javascript:void(0)" class="btn btn-sm btn-default btn-delete" onclick="deleteItem('MembershipController/deleteTransactionUsersPost','<?= $item->id; ?>','<?= trans("confirm_delete"); ?>');"><i class="fa fa-trash-o"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach;
