<div class="row" style="margin-bottom: 15px;">
    <div class="col-sm-12">
        <h3 style="font-size: 18px; font-weight: 600;"><?= trans('contactUs-report'); ?></h3>
    </div>
</div>
<div class="box">
        ...
        <div class="row">
            <div class="col-sm-12">
                        ...
                        if (!empty($contact)):
                            foreach ($contact as $item):?>
                                <tr>
                                    ...
                                    <td><?= formatDate($item->submited_on); ?></td>
                                    <td>
                                        <form action="<?= base_url('AdminController/approveContactUsPost'); ?>" method="post">
                                            <?= csrf_field(); ?>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="pull-left">
                            <button class="btn btn-sm btn-danger btn-table-delete" onclick="deleteSelectedContactUsForms('<?= trans("confirm_feedbacks", true); ?>');"><?= trans('delete'); ?></button>
                            <?php if ($showApproveButton == true): ?>
                                <button class="btn btn-sm btn-success btn-table-delete" onclick="approveSelectedContactUsForms();"><?= trans('approve'); ?></button>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
