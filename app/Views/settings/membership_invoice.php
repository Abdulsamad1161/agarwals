		...
		*/ ?>
		...
		<div class="row">
			...
			<div class="col-md-8 col-sm-12">
				<div class="title">
					<h1 class="picture_gallery_h1"><?= trans("membership_invoice"); ?></h1>
				</div>
			</div>
			<div class="col-md-2"></div>
		</div>
                            ...
                            <table class="table table-bordered table-striped cs_datatable_lang" role="grid" aria-describedby="example1_info">
                                ...
                                <?php if (!empty($ticket_report)):
                                    ...
                                    foreach ($ticket_report as $item): 
                                        ...
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td>#ABC-MP<?= esc($item['id']); ?></td>
                                            <td><?= esc($item['plan_title']); ?></td>
                                            <td><?= esc($item['payment_id']); ?></td>
                                            <td class="text-success text-right"><?= $defaultCurrency->symbol; ?><?= esc($item['payment_amount']); ?></td>
											<td><?= esc($item['created_at']); ?></td>
                                            <td class="text-center"><a href="<?= base_url('invoice-membership-users/' . $item['id']); ?>"><i class="fa fa-eye eye-icon"></i></a></td>
                                        </tr>
                                    <?php 
									$i++;
									endforeach;
