<div class="row">
    <div class="col-12">
        ...
        <div class="row-custom price">
            ...
            if ($showAsk == true):?>
                <?php if (authCheck()): ?>
                    <button class="btn btn-contact-seller" data-toggle="modal" data-target="#messageModal" style="color: black !important;"><i class="icon-envelope"></i> <?= trans("ask_question") ?></button>
                <?php else: ?>
    ...
    <form action="<?= getProductFormData($product)->addToCartUrl; ?>" method="post" id="form_request_quote">
        ...
        <div class="row">
            ...
            <?php if (!empty($product->demo_url)): ?>
                <div class="col-12 product-add-to-cart-container">
                    <div class="button-container">
                        <a href="<?= $product->demo_url; ?>" target="_blank" class="btn btn-md btn-live-preview" style="color : black !important;"><i class="icon-preview"></i><?= trans("live_preview") ?></a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
