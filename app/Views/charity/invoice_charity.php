            ...
            <div class="container-invoice">
                <div id="content" class="card">
                    <div class="card-body invoice p-0">
                        <div class="row">
                            <div class="col-12">
                                <h1 style="text-align: center; font-size: 36px;font-weight: 400;margin-top: 20px;"><?= trans("charity"); ?>&nbsp;<?= trans("invoice"); ?></h1>
                            </div>
                        </div>
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= trans("invoice"); ?>:</span>#ABC-C/D-<?= $transaction->id; ?></p>
                                    <p class="font-weight-bold"><span style="display: inline-block;width: 100px;"><?= trans("date"); ?>:</span><?= formatDate($transaction->payment_date); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            <div class="col-6">
                                ...
                                <p class="mb-1"><?= esc($user->first_name); ?>&nbsp;<?= esc($user->last_name); ?></p>
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    ...
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= trans("payment_status"); ?>:</span><?= getPaymentStatus($transaction->payment_status); ?></p>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-0 font-weight-bold"><?= trans("form_name"); ?></th>
                                            <th class="border-0 font-weight-bold"><?= trans("total"); ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr style="font-size: 15px;">
                                            <td><?= trans("charity_payment"); ?></td>
                                ...
                                <div class="order-total float-right">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6 col-right">
                                            <?php if (!empty($currency) && $currency->symbol_direction == 'left'): ?>
                                                <strong class="font-600"><?= getCurrencySymbol($transaction->currency); ?><?= $transaction->charity_amount; ?></strong>
                                            <?php else: ?>
                                                <strong class="font-600"><?= $transaction->charity_amount; ?><?= getCurrencySymbol($transaction->currency); ?></strong>
                                            <?php endif; ?>
                                        </div>
                                    </div>
									<div class="row mb-2">
                                        ...
                                        <div class="col-6 col-right">
                                            <?php if (!empty($currency) && $currency->symbol_direction == 'left'): ?>
                                                <strong class="font-600"><?= getCurrencySymbol($transaction->currency); ?><?= $transaction->paypal_charges; ?></strong>
                                            <?php else: ?>
                                                <strong class="font-600"><?= $transaction->paypal_charges; ?><?= getCurrencySymbol($transaction->currency); ?></strong>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
