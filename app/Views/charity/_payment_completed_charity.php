        ...
        <div class="row">
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <?php if(!empty(helperGetSession('modesy_charity_request_type')) && helperGetSession('modesy_charity_request_type') == 'paymentCharity'): ?>
                    <p class="m-t-15 text-success"><?= trans("msg_charity_collected"); ?></p>
                    <?php else: ?>
                    ...
                    <div class="m-t-45 text-center">
                        <a href="<?= base_url('invoice-charity/'. $transaction->id); ?>" class="btn btn-lg btn-info color-white" target="_blank"><i class="icon-text-o"></i>&nbsp;&nbsp;<?= trans("view_invoice"); ?></a>
                        <?php if(!empty(helperGetSession('modesy_charity_request_type')) && helperGetSession('modesy_charity_request_type') == 'paymentCharity'): ?>
...
helperDeleteSession('charity_details'); 
