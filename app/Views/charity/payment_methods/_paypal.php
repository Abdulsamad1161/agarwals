        ...
        paypal.Buttons({
            createOrder: function (data, actions) {
                return actions.order.create({
                    purchase_units: [{
						...
						description: 'Charity - <?= helperGetSession('charity_details'); ?> By <?= helperGetSession('mds_ses_username'); ?>'
                    }]
                });
            },
            onApprove: function (data, actions) {
                return actions.order.capture().then(function (details) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: MdsConfig.baseURL + '/paypal-payment-post-charity', //paypal-payment-post
