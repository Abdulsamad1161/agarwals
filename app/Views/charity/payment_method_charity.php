                        ...
                        <div class="col-sm-12 col-lg-8">
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-open">
                                    ...
                                    <form action="<?= base_url('SponsorshipController/paymentMethodPostUsers'); ?>" method="post" id="form_validate" class="validate_terms">
                                        <?= csrf_field(); ?>
...
<script>
	...
	radio.addEventListener("click", function() {
		swal({
		  ...
		  text: "You can complete your e-payment by using the provided email address (abcpayment20@gmail.com). Thank you!",
		  buttons: [
			'back',
			'ok'
		  ],
		  ...
		  if (isConfirm) {
				window.location.href = "<?= generateUrl('charity'); ?>"
		  } 
		});
	});
</script>
