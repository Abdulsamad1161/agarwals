        ...
        <div class="row">
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <?php if(!empty(helperGetSession('modesy_rsvp_request_type')) && helperGetSession('modesy_rsvp_request_type') == 'paymentRSVP'): ?>
                    <p class="m-t-15 text-success"><?= trans("msg_rsvp_collected"); ?></p>
                    <?php else: ?>
                    ...
                    <div class="m-t-45 text-center">
                        <a href="<?= base_url('invoice-rsvp/'. $transaction->id); ?>" class="btn btn-lg btn-info color-white" target="_blank"><i class="icon-text-o"></i>&nbsp;&nbsp;<?= trans("view_invoice"); ?></a>
                        <?php if(!empty(helperGetSession('modesy_rsvp_request_type')) && helperGetSession('modesy_rsvp_request_type') == 'paymentRSVP'): ?>
...
helperDeleteSession('rsvpFormDetails'); 
