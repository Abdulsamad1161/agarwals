                        ...
                        <div class="col-sm-12 col-lg-8">
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-open">
                                    ...
                                    <form action="<?= base_url('ProfileController/paymentMethodPostUsers'); ?>" method="post" id="form_validate" class="validate_terms">
                                        <?= csrf_field(); ?>
                                                                    ...
                                                                    <div class="option-payment">
                                                                        <div class="list-left">
                                                                            <div class="custom-control custom-radio">
                                                                                <input type="radio" class="custom-control-input" id="option_<?= $gateway->id; ?>" name="payment_option" value="<?= esc($gateway->name_key); ?>" required <?= $i == 0 ? '' : ''; ?>>
...
<script>
	...
	radio.addEventListener("click", function() {
		swal({
		  ...
		  text: "Your data has submitted successfully, You can complete your e-payment by using the provided email address (abcpayment20@gmail.com). Thank you!",
		  buttons: [
			'back',
			'ok'
		  ],
		  dangerMode: true,
			...
			if (isConfirm) 
			{
				...
				$.ajax({
					type: 'POST',
					url: MdsConfig.baseURL + '/ProfileController/rsvp_payment_epyament',	
					...
					success: function (response) {
						...
						{
							window.location.href = "<?= generateUrl('rsvpEventForm'); ?>"
						}
					}
				});
