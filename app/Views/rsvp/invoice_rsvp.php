        ...
        <div class="col-12">
            <div class="container-invoice">
                <div id="content" class="card">
					<div class="row">
                            <div class="col-12">
                                <h5 style="text-align: right; font-size: 16px;font-weight: 600;margin-top: 10px;color:red;"><span class="text-red" style="font-weight:bold;">**</span>Please Note the Invoice Number For Future<span class="text-red" style="font-weight:bold;">**</span></h5>
                            </div>
                        </div>
                    <div class="card-body invoice p-0">
                        <div class="row">
                            <div class="col-12">
                                <h1 style="text-align: center; font-size: 36px;font-weight: 400;margin-top: 20px;"><?= trans("rsvp_form_payment"); ?>&nbsp;<?= trans("invoice"); ?></h1>
                            </div>
                        </div>
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= trans("invoice"); ?>:</span>#ABC-RSVP-<?= $transaction->id; ?></p>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr style="font-size: 15px;">
                                            <td><?= trans("rsvp_payment"); ?></td>
                                            <td><?= $transaction->form_title; ?></td>
