<div class="col-sm-12">
    <div id="video_upload_result">
        <?= view('dashboard/product/_video_upload_response_gallery'); ?>
    </div>
</div>
...
<script>
    $('#drag-and-drop-zone-video').dmUploader({
        url: '<?= base_url('upload-video-gallery-post'); ?>',
    ...
    function loadVideoPreview(productId) {
        ...
        $.ajax({
            type: 'POST',
            url: MdsConfig.baseURL + '/load-video-preview-gallery-post',
            ...
            success: function (response) {
				...
				$('#video_save_button').css('display','block');
            }
        });
    }
</script>
