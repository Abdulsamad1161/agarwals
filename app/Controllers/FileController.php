...
class FileController extends BaseController
{
    ...
    {
        $productId = inputPost('product_id');
        $this->fileModel->uploadGalleryVideo($productId);
        echo $productId;
    }
	...
	//load video preview
    public function loadVideoGalleryPreview()
    {
        $productId = inputPost('product_id');
        $data['productVideo'] = $this->fileModel->getProductVideoGallery($productId);
        echo view('dashboard/product/_video_upload_response_gallery', $data);
    }
	...
	public function deleteVideoGallery()
    {
        ...
        $this->fileModel->deleteGalleryVideo($productId);
