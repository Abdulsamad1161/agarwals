...
$routes->get($rtAdmin . '/videogallery', 'GalleryController::videoindex');
...
//page
$routes->get($rtAdmin . '/documents', 'AdminController::documentsList');
...
$routes->get($rtAdmin . '/add-board-directors-sub', 'AdminController::addboardOfDirectorsSub');
...
$routes->get($rtAdmin . '/edit-board-directors-sub/(:num)', 'AdminController::editboardOfDirectorsSub/$1');
...
$routes->get($rtAdmin . '/board-of-directors-sub', 'AdminController::boardOfDirectorsSub');
...
$routes->get($rtAdmin . '/deleted-rsvp-form', 'RSVPController::deletedRSVPForm');
//order
...
$routes->get($rtAdmin . '/ticket-generate', 'TicketBookingController::generatePDF_test');
...
$routes->get($rtAdmin . '/confirm-remainder-email/(:num)/(:num)/(:num)', 'TicketController::remainderEmailTicketsConfirmed/$1/$2/$3'); 
...
$routes->get($rtAdmin . '/regsitration-form-event/(:num)', 'GalleryController::showRegistrationForm/$1');
...
$routes->get($rtAdmin . '/update-plan-details/(:num)', 'MembershipController::updatePlanUsers/$1');
//support
...
$routes->get($rtAdmin . '/edit-documents/(:num)', 'AdminController::editDocument/$1');
...
$routes->get($rtAdmin . '/edit-registration-form/(:num)', 'AdminController::eventRegistrationFormEdit/$1');
...
if (!empty($languages)) {
    foreach ($languages as $language) {
        ...
        $routes->get($key . $csrt->rsvpEventForm_jot, 'ProfileController::rsvpEventForm_jot');
		$routes->get($key . $csrt->document, 'GalleryController::document');
        ...
        $routes->get($key . $csrt->aboutUs.'/' . $csrt->boardOfDirectorsListPast, 'MembersController::boardOfMembersListPast'); 
        ...
        $routes->get($key . $csrt->videogallery, 'GalleryController::videogalleryindex'); //new controller added
