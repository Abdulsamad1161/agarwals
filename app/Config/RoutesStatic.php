...
$routes->post('register-post-new', 'AuthController::registerNewMethodPost');
...
$routes->post('register-post', 'AuthController::registerPost');
$routes->get('captcha', 'AuthController::generateCaptcha');
//bidding
...
$routes->post('business-customer-communication', 'SponsorshipController::buisnessCommunicationCustomer');
$routes->post('ticket-selection-data', 'TicketBookingController::ticketSelectionData');
$routes->post('reserve-ticket-selection-data', 'TicketBookingController::reserveTicketSelectionData');
$routes->post('reserve-ticket-selection-data-remove', 'TicketBookingController::reserveTicketRemoveData');
$routes->post('ticket-temp-selection-data-deleted', 'TicketBookingController::tempTicketDataDeleted');
$routes->post('ticket-temp-selection-data-reserved-not', 'TicketBookingController::tempTicketDataReservedNot');
...
$routes->post('upload-video-gallery-post', 'FileController::uploadGalleryVideo');
$routes->post('load-video-preview-post', 'FileController::loadVideoPreview');
$routes->post('load-video-preview-gallery-post', 'FileController::loadVideoGalleryPreview');
...
$routes->post('change-password-second-post', 'ProfileController::changePasswordSecondPost');
